          ...
          <div className="container px-4 md:px-6 flex flex-col items-center text-center space-y-8">
            ...
            <div className="space-y-4 max-w-3xl">
              ...
              <p className="mx-auto max-w-175 text-muted-foreground md:text-xl leading-relaxed">
                The intuitive Kanban board designed for modern teams. Drag,
                drop, collaborate, and ship faster without the clutter.
              </p>
            </div>
          ...
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto">
              ...
              <Card className="bg-background border-border/50 shadow-sm hover:shadow-md transition-shadow">
                ...
                <CardContent>
                  <CardDescription className="text-base">
                    Your data is encrypted at rest and in transit. SOC2
                    compliant infrastructure you can trust with your biggest
                    projects.
                  </CardDescription>
                </CardContent>
              </Card>
