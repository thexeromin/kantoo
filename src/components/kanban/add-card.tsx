...
export default function AddCard({ onAdd }: Props) {
  ...
  if (!shouldAdd) {
    return (
      <button
        ...
        className="group flex  shrink-0 items-center justify-center gap-2 rounded-xl border-2 border-dashed border-slate-300 bg-slate-50/50 p-3 transition-all hover:border-blue-400 hover:bg-white hover:shadow-md dark:border-gray-700 dark:bg-gray-800/30 dark:hover:border-blue-500 dark:hover:bg-gray-800"
      >
  ...
  return (
    <div className="shrink-0 rounded-xl bg-slate-100 p-4 shadow-sm ring-1 ring-slate-200 dark:bg-gray-800 dark:ring-gray-700 h-fit">
