...
export default function AddColumn({ onAdd }: Props) {
  ...
  if (!shouldAdd) {
    return (
      <button
        ...
        className="group flex w-80 shrink-0 items-center justify-center gap-2 rounded-xl border-2 border-dashed border-border bg-transparent p-6 transition-all hover:border-primary hover:bg-accent hover:shadow-md"
      >
  ...
  return (
    <div className="w-80 shrink-0 rounded-xl bg-muted/50 p-4 shadow-sm ring-1 ring-border h-fit">
